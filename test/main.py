...
class AutoCP:
    ...
    def setup_gui(self):
        ...
        title_label = ttk.Label(main_frame, text="Auto CP Bot", font=("Helvetica", 16, "bold"))
    ...
    def get_virtual_key_code(self, key_char):
        """Преобразует символ в виртуальный код клавиши."""
        try:
    ...
    def auto_cp_loop(self):
        while self.running:
            ...
            try:
                ...
                # Исправленный код: проверка и создание папки
